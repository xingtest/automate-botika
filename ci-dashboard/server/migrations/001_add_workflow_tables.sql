...
CREATE TABLE IF NOT EXISTS workflows (
  ...
  definition JSONB NOT NULL,           -- Complete workflow definition (nodes, connections)
...
CREATE INDEX idx_wf_name ON workflows(name);
...
CREATE INDEX idx_wfv_version ON workflow_versions(version);
...
CREATE INDEX idx_wfe_execution_id ON workflow_executions(execution_id);
...
CREATE INDEX idx_ne_node_type ON node_executions(node_type);
...
CREATE INDEX idx_wfp_permission ON workflow_permissions(permission);
